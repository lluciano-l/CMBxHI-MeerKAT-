...
class UnivMeerKlass(Universe):
   ...
   def __init__(self):
      ...
      # background universe
      # MeerKlass h=0.678. (Planck15 used h=0.6712)
      self.h = 0.678  # H0 = 100.*h km s^-1 Mpc^-1
      
      # Derived from your CAMB param: ombh2=0.0222 -> OmB = 0.0222 / (0.678^2)
      # MeerKlass OmB=0.04829. (Planck15 used OmB=0.0493)
      self.OmB = 0.04829
      
      # Derived from your CAMB param: omch2=0.119 -> OmC = 0.119 / (0.678^2)
      # MeerKlass OmC=0.25887. (Planck15 used OmC=0.267)
      self.OmC = 0.25887
      
      # MeerKlass OmM=0.30716. (Planck15 used OmM=0.3163)
      self.OmM = self.OmC + self.OmB
      
      # read linear power spectrum from CAMB
      # SAVED IN THE PLANCK15 FOLDER, BUT WITH A UNIQUE NAME
      self.path_lin_matterpower = "./input/universe_Planck15/camb/matterpower_z0_lin_MeerKlass.dat"
      
      super(UnivMeerKlass, self).__init__()
